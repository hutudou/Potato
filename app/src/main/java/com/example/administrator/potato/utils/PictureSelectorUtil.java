...
import com.example.administrator.potato.activity.PictureSelectorActivity;
...
public class PictureSelectorUtil {
    public static void initPictureSelector(Activity activity, List<LocalMedia> list) {
