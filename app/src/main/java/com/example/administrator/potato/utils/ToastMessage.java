...
public class ToastMessage {
     ...
     * @param text 需要显示的消息
     */
    public static void toastSuccess(@NonNull String text) {
        toastSuccess(text, false);
    }
     ...
     * @param text 需要显示的消息
     */
    public static void toastError(@NonNull String text) {
        toastError(text, false);
    }
     ...
     * @param text 需要显示的消息
     */
    public static void toastWarn(@NonNull String text) {
        toastWarn(text, false);
    }
}
